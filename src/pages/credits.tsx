...
import { normalizeCSSLicense } from '../data/normalize-css-license';
...
function StylingSection() {
    return (
        <section>
            ...
            <p>
                The stylesheets generated by Tailwind CSS also include a version
                of{' '}
            ...
            <details className="mt-1">
                ...
                <CodeBlock code={normalizeCSSLicense} language="plain" />
            </details>
        </section>
    );
}
